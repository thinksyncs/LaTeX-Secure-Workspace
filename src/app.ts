...
lw.event = event
const { file } = require('./core/file') as typeof import('./core/file')
lw.file = file
const { watcher } = require('./core/watcher') as typeof import('./core/watcher')
lw.watcher = watcher
const { cache } = require('./core/cache') as typeof import('./core/cache')
lw.cache = cache
const { root } = require('./core/root') as typeof import('./core/root')
lw.root = root
const { parser } = require('./parse') as typeof import('./parse')
void parser.parse.reset()
lw.parser = parser
const { compile } = require('./compile') as typeof import('./compile')
lw.compile = compile
const { preview, viewer } = require('./preview') as typeof import('./preview')
lw.viewer = viewer
lw.preview = preview
const { SecurePdfCustomEditorProvider } = require('./preview/pdfcustomeditor') as typeof import('./preview/pdfcustomeditor')
const { locate } = require('./locate') as typeof import('./locate')
lw.locate = locate
const { completion } = require('./completion') as typeof import('./completion')
lw.completion = completion
const { language } = require('./language') as typeof import('./language')
lw.language = language
const { lint } = require('./lint') as typeof import('./lint')
lw.lint = lint
const { outline } = require('./outline') as typeof import('./outline')
lw.outline = outline
const { extra } = require('./extras') as typeof import('./extras')
lw.extra = extra

const commander = require('./core/commands') as typeof import('./core/commands')
